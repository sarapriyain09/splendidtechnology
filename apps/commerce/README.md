...
- [COMMERCE_PLATFORM_PHASED_PLAN.md](COMMERCE_PLATFORM_PHASED_PLAN.md)
- [PHASE2_EPICS_BACKLOG.md](PHASE2_EPICS_BACKLOG.md)
- [Commerce Platform Phase 2 Architecture Blueprint](../../docs/strategy/velynxia-commerce-platform-phase2-architecture.md)
...
- Added CI workflow for Commerce Platform pull requests to run backend pytest and frontend Playwright checks.
...
- Added scoped git hygiene for local generated artifacts via `apps/commerce/.gitignore`.
...
Run migrations from `apps/commerce/backend`:
