...
export const metadata = {
  title: "Web App Portfolio | Splendid Technology",
  description:
    "Real web apps and platforms built by Splendid Technology — from AI-powered mentorship tools to food ordering sites and coding education platforms.",
};
