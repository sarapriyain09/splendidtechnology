...
export const metadata: Metadata = {
  title: { absolute: "Velynxia CRM | Customer Growth Platform" },
  description:
    "Manage contacts, companies, activities, tasks, notes, and documents in one CRM built for growing SMEs.",
  alternates: {
    canonical: "/crm",
  },
};

const features = ["Contacts", "Companies", "Activities", "Tasks", "Notes", "Documents"];

export default function CrmPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#46618f]">Product</p>
      <h1 className="mt-2 text-4xl font-bold text-[#0e1629] sm:text-5xl">CRM</h1>
      <p className="mt-4 max-w-3xl text-base leading-7 text-[#44567a]">
        Manage customers and relationships with a single source of truth across sales, service, and operations.
      </p>
